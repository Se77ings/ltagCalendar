    ...
    <>
      <View style={styles.container}>
        ...
        <View style={{ flex: 1, alignItems: "center", height: "100%", justifyContent: "center" }}>
          ...
          {/* <TourGuideZone zone={8} text="Nessa área, você conseguirá acessar a lista de clientes que já foram atendidos pela nossa empresa." style={{ justifyContent: "center", width: "50%", borderRadius:10}}>
...
const Config = () => {
  return (
    <Stack.Navigator initialRouteName="ConfigScreen">
      <Stack.Screen name="ConfigScreen" component={ConfigScreen} options={{ headerShown: true, headerTitle: "Configurações", headerTitleAlign: "center"  }} />
