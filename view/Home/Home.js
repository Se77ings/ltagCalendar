      ...
      <View style={styles.botoes}>
        ...
        {!item.Finalizado && (
          <>
            ...
            <TouchableOpacity style={[styles.botao, {}]} onPress={() => copiarParaClipboard(item)}>
              <Ionicons name="clipboard-outline" color={"#0045a0"} size={22} />
            </TouchableOpacity>
            <TouchableOpacity style={[styles.botao, {}]} onPress={() => compartilharTexto(item)}>
              <Ionicons name="share-social-outline" color={"#0045a0"} size={22} />
            </TouchableOpacity>
          </>
        )}
      </View>
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <ScrollView stickyHeaderIndices={[1]} contentContainerStyle={{}}>
          <Header title={"Menu Inicial"} primeiraInicializacao={primeiraInicializacao} atualizarDB={atualizarDB} />
