      ...
      <View style={styles.scrollContainer}>
        ...
        {editar && (
          <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
            <View style={{ width: "50%", margin: 10 }}>
              <Button color={"#666699"} style={styles.button} title="Alterar Imagem" onPress={pickImage} />
            </View>
            <View style={{ width: "50%", margin: 10 }}>
              <Button
                color={"red"}
        ...
        <View style={{ width: "80%" }}>
          <View style={{ flexDirection: "column" }}>
            ...
            <TextInput style={styles.input} value={estabelecimento.Nome} editable={editar} onChangeText={(value) => setEstabelecimento({ ...estabelecimento, Nome: value })} />
          ...
          <View style={{ flexDirection: "column" }}>
            ...
            <TextInput style={styles.input} value={estabelecimento.Endereco} editable={editar} onChangeText={(value) => setEstabelecimento({ ...estabelecimento, Endereco: value })} />
          </View>
        </View>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          <View style={{ width: "35%", margin: 5 }}>
            <Button disabled={!editar} color={"green"} style={styles.button} title="Salvar" onPress={handleSalvar} />
          </View>
        </View>
      </View>
    </View>
