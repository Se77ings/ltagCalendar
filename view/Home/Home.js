      ...
      <View style={[styles.container]}>
        ...
        <ScrollView contentContainerStyle={{}}>
          ...
          {filterAgendamentos(agendamentos).length != 0 ? (
            <>
              <Cards data={filterAgendamentos(agendamentos)} setAgendamentoSelecionado={setAgendamentoSelecionado} setOption={setOption} setmodalCreate={setmodalCreate} obter={obter} />
            </>
          ) : (
